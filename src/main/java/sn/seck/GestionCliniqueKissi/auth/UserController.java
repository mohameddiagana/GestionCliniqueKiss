...
@RestController
@RequestMapping(path = "http://localhost:8190/api/v1/auth/users")
@Slf4j
public class UserController {
   // @Autowired
    ...
    public Users updateUserRole(@PathVariable int iduser, @RequestBody Role newRole) {
        Optional<Users> userOpt = userRepository.findById(iduser);
